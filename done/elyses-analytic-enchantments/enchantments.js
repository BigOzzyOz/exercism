...
export function isEachCardEven(stack) {
  return stack.every(cardIndex => cardIndex % 2 === 0);
}
...
export function doesStackIncludeOddCard(stack) {
  return stack.some(cardIndex => cardIndex % 2 === 1);
}
...
export function getFirstOddCard(stack) {
  return stack.find(cardIndex => cardIndex % 2 === 1);
}
...
export function getFirstEvenCardPosition(stack) {
  return stack.findIndex(cardIndex => cardIndex % 2 === 0);
}
